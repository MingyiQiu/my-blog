import { A as AstroError, N as NoImageMetadata, v as UnsupportedImageFormat, w as MissingSharp } from './entrypoint_vkPIY88T.mjs';
import { b as baseService, d as detector, c as resolveDefaultOutputFormat, p as parseQuality } from './deterministic-string_BK7d2H1y.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DC4kmHYh.mjs').then(n => n.i)).default;
  } catch {
