import { e as renderElement, g as generateCspDigest, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, f as removeBase, b as isRemotePath, h as unflatten, A as AstroError, U as UnknownContentCollectionError, o as object, j as date, k as array, R as RenderUndefinedEntryError, l as escape, n as string, p as prependForwardSlash, q as createHeadAndContent, d as renderComponent } from './entrypoint_vkPIY88T.mjs';
import { c as createComponent, V as VALID_INPUT_FORMATS } from './consts_BFjwU0Ks.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_2T0vSlM0.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_dDYgUbKH.mjs');
